    ...
    @foreach($gajis as $gaji)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('gajis.show', [$gaji->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('gajis.edit', [$gaji->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
